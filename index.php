...
<button class="tablink" onclick="openPage('News', this, 'green')" id="defaultOpen">secLounge 2.0 (351)</button>
<button class="tablink" onclick="openPage('Contact', this, 'blue')">bearXXSing</button>
<button class="tablink" onclick="openPage('About', this, 'orange')">LOIC</button>
...
<div id="News" class="tabcontent">
  ...
  <summary>DOM</summary>
    ...
    DOM-based XSS can be either reflected or stored and the differentiation lies in how the attack is targeted. Most attacks will strike at the immediate markup of a HTML document. However, HTML may also be manipulated by Javascript using the DOM. An injected payload, rendered safely in HTML, might still be capable of interfering with DOM operations in Javascript. There may also be security vulnerabilities in Javascript libraries or their usage which can also be targeted.
  		...
  		<div id="food" onClick="eat()"></div>
      <div id="drink" onClick="drink()"></div>

      <div id="receipt" style="display:none"></div>
      <div id="countertop" style="display:none">

        <img src="drive/Fork.gif" style="position:absolute">
        <img src="drive/Spoon.gif" style="position:absolute">
        <img src="drive/Platter.jpg" style="width:625px;margin-left:17%;">
  			<img src="items/chopsticks.png" style="position:absolute" width="205" height="205">
  			<button id = "refresh" onclick ="window.location.reload();"> Go Back </button>

  			<audio id="Dust">
  				<source src="Dust.mp3" type="audio/mpeg">
  			</audio>
        <input type="submit" value="New Order" onclick="newOrder()" style="margin-left:14.5%;">
      </div>
...
<div class="container">
  ...
  <div>
    <h2>FIND THE FLAGS</h2>
  <details>
  <summary>FLAG 1: basic I INJECTION</summary>
