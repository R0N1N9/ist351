...
<body style="background-image: url('img/nightcity.gif')">



<div style="background-image: url('img/outrun.gif')" class="container">

<header class="blinkingyellow" style="background-image: url('img/steamuserimages-a.akamaihd.net.gif')">JR Gumarin IST 276 Project: Simple CTF</header>

<!--Title -->
<h2 id="rcorners" class="blinking">Howdy!</h2>
<h3 id="rcorners" class="blinkingyellow" style="background-image: url('img/walking.gif')">Welcome to the secLounge!</h3>
...
<summary>CTF</summary>
	...
	<h1>You can input the flags here, or at each stage:</h1>
		...
		<script src="js/92bb42b845168fad6f9ccf3d50448512.js"></script>
</div>
</details>
</div>
...
<div>
	...
	<img src="img/drive_embed.gif" alt="drive" height="500" width="800">
...
<h1>input the flag here:</h1>
	...
	<script src="js/js/92bb42b845168fad6f9ccf3d50448512.js"></script>
</div>
<details>
<summary>HINT</summary>
